...
function coreMarkup(page){
  ...
  return `<main class="seo-landing-page seo-core-page" data-static-route="${escapeHtml(page.path)}">
    ...
    ${isHome?`<section class="seo-local-facts section" aria-label="Informations essentielles"><div><span>Atelier</span><strong>Agdal, Rabat</strong></div><div><span>Commande</span><strong>À partir de 320 DH</strong></div><div><span>Contact</span><strong>+212 6 76 68 38 35</strong></div></section>`:''}
